...
def length_vector(vector):
    return math.sqrt((vector.z ** 2 + vector.x ** 2 + vector.y ** 2))
...
# I kept getting errors for these tests, so I didn't include them;
# the program tells me that list 'x' has no attribute, so I'm unsure on how to fix it
